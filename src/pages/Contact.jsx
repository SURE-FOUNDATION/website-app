  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-16 sm:py-20 px-5 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-[#4a0f3f]">
          ...
          <div className="rounded-3xl overflow-hidden shadow-lg grid md:grid-cols-[2fr_3fr]">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="text-white/80 text-sm space-y-1">
                    <a
                      ...
                      href="tel:+2347066574117"
                    >
                      +234 7066574117
                    </a>
                    <a
                      className="block hover:text-[#F069B4] transition-colors"
                      href="tel:+2348032750680"
                    >
                      +234 8032750680
                    </a>
                    <a
                      className="block hover:text-[#F069B4] transition-colors"
                      href="tel:+2347070879787"
                    >
                      +234 7070879787
                    </a>
                  </div>
            ...
            <div className="bg-white px-8 py-10">
              <h3 className="text-lg font-bold text-[#4a0f3f] mb-6">
                Send us a Message
              </h3>
      ...
      <section className="pb-16 px-5">
        <div className="max-w-5xl mx-auto">
          <h3 className="text-lg font-semibold text-[#4a0f3f] mb-4">
            Our Location
          </h3>
          <iframe
